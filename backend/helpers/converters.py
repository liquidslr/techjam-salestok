...
def converts_keys(
    data: T, *, case: str = "snake", inplace: bool = False, **kwargs
) -> T:
    if case == "camel":
...
def datetime_day_month_year(datetime):
    """
    Use this function to format datetime to year-month-day

    :param datetime: ``datetime`` object
    :return str, formatted date str (YYYY-MM-DD)
    """

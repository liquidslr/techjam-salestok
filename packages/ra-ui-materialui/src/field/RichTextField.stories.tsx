...
const record = {
  ...
  body: `
<p>
<strong>War and Peace</strong> is a novel by the English author <a href="https://en.wikipedia.org/wiki/Leo_Tolstoy">Leo Tolstoy</a>,
...
export const Secure = () => (
  <RecordContextProvider
    value={{
      ...
      body: `
<p>
<strong>War and Peace</strong> is a novel by the English author

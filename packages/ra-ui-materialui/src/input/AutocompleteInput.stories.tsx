...
export const OptionTextElement = () => (
  <Wrapper>
    <AutocompleteInput
      ...
      choices={[
        { id: 1, fullName: 'Leo Tolstoy', language: 'English' },
        { id: 2, fullName: 'Victor Hugo', language: 'English' },
        { id: 3, fullName: 'William Shakespeare', language: 'English' },
        { id: 4, fullName: 'Charles Baudelaire', language: 'English' },
        { id: 5, fullName: 'Marcel Proust', language: 'English' },
      ]}
    />
  </Wrapper>
);
...
export const OnCreatePrompt = () => (
  <Wrapper>
    <AutocompleteInput
      ...
      choices={choicesForCreationSupport}
      onCreate={(filter) => {
        const newAuthorName = window.prompt('Enter a new author', filter);
...
const authorsWithFirstAndLastName = [
  { id: 1, first_name: 'Leo', last_name: 'Tolstoy', language: 'English' },
  { id: 2, first_name: 'Victor', last_name: 'Hugo', language: 'English' },
  {
    id: 3,
    first_name: 'William',
  ...
  { id: 5, first_name: 'Marcel', last_name: 'Proust', language: 'English' },
];
  ...
  getList: (_resource, params) =>
    new Promise((resolve) => {
      ...
      const filteredAuthors = authorsWithFirstAndLastName.filter((author) =>
        author.last_name.toLowerCase().includes(params.filter.q.toLowerCase())
      );
...
const authors = [
  { id: 1, name: 'Leo Tolstoy', language: 'English' },
  { id: 2, name: 'Victor Hugo', language: 'English' },
  { id: 3, name: 'William Shakespeare', language: 'English' },
  { id: 4, name: 'Charles Baudelaire', language: 'English' },
  { id: 5, name: 'Marcel Proust', language: 'English' },
];
...
const BookEditWithReferenceAndCreationSupport = () => (
  ...
  >
    <SimpleForm>
      <ReferenceInput reference="authors" source="author">
        <AutocompleteInput create={<CreateAuthor />} optionText="name" />
      </ReferenceInput>
    </SimpleForm>
  </Edit>
);
            ...
            <SimpleForm>
              <ReferenceInput reference="authors" source="author">
                <AutocompleteInput
                  ...
                  inputText={(book) => `${book.name} - ${book.language}`}
                  {...props}
                />
              </ReferenceInput>
            </SimpleForm>
    ...
    <AdminContext dataProvider={dataProviderWithAuthors}>
      <SimpleForm onSubmit={() => {}} defaultValues={{ role: 2 }}>
        <AutocompleteInput
          ...
          matchSuggestion={(filter, option) => option.name.includes(filter)}
          choices={[
            { id: 1, name: 'bar' },
            { id: 2, name: 'foo' },
          ]}
          ...
          >
            <Box sx={{ width: '320px' }}>
              <Typography variant="body1">
                <b>Fan #{fan.id}</b>
                <br />
                <code>{`${fan.name} [${typeof fan.prefers}]`}</code>
              </Typography>
            </Box>
            <Box sx={{ flex: '1 1 100%' }}>
              <SimpleForm toolbar={<></>}>
...
export const NullishValuesSupport = () => {
  return (
    <AdminContext dataProvider={fakeRestProvider(nullishValuesFakeData, false)}>
      <Typography variant="h6" gutterBottom>
        Test nullish values
      </Typography>
      <Typography variant="body1">
        Story demonstrating nullish values support: each fan specify a preferred
        artist. The <code>prefer</code> value is evaluated against artist IDs.
      </Typography>

    ...
    >
      <SimpleForm>
        <Stack direction="row">
          ...
          <Box>
            <SelectArrayInput source="title" sx={{ width: 300 }} disabled />
            <SelectArrayInput
              source="title"
              variant="outlined"
              sx={{ width: 300 }}
    ...
    >
      <SimpleForm>
        <Stack direction="row">
          ...
          <Box>
            <SelectArrayInput source="title" sx={{ width: 300 }} readOnly />
            <SelectArrayInput
              source="title"
              variant="outlined"
              sx={{ width: 300 }}
...
export const TranslateChoice = () => {
  ...
  return (
    <AdminContext
      ...
      dataProvider={
        {
          getOne: () => Promise.resolve({ data: { id: 1, tags: ['tech'] } }),
          getList: () =>
            Promise.resolve({
              data: [
    ...
    <Admin dataProvider={dataProviderWithAuthors}>
      ...
      <Resource
        ...
        edit={() => (
          ...
          >
            <SimpleForm>
              <ReferenceArrayInput reference="authors" source="authors">
                <SelectArrayInput />
              </ReferenceArrayInput>
  ...
  <TestMemoryRouter initialEntries={['/books/1']}>
    <Admin
      dataProvider={{
        ...dataProviderWithAuthors,
        getList: () =>
          Promise.reject(new Error('Error while fetching the authors')),
      }}
    >
      <Resource
        name="authors"

    ...
    >
      <SimpleForm>
        <AutocompleteArrayInput
          ...
          readOnly
        />
        <AutocompleteArrayInput source="authors" choices={[]} readOnly />
      </SimpleForm>
    </Create>
  </AdminContext>
);
    ...
    >
      <SimpleForm>
        <AutocompleteArrayInput
          ...
          disabled
        />
        <AutocompleteArrayInput source="authors" choices={[]} disabled />
      </SimpleForm>
    </Create>
  </AdminContext>
);
    ...
    >
      <SimpleForm>
        <AutocompleteArrayInput
          ...
          inputText={(record) => `${record.fullName} (${record.language})`}
...
const BookEditWithReferenceAndCreationSupport = () => (
  ...
  >
    <SimpleForm>
      <ReferenceArrayInput reference="authors" source="author">
        <AutocompleteArrayInput create={<CreateAuthor />} optionText="name" />
      </ReferenceArrayInput>
    </SimpleForm>
  </Edit>
);

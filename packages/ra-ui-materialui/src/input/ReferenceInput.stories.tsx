    ...
    <Paper>
      <Form onSubmit={() => {}} defaultValues={{ tag_ids: [5] }}>
        ...
        <Stack direction="row" spacing={2}>
          ...
          <Stack sx={{ width: 200 }}>
            <ReferenceInput reference="tags" resource="posts" source="tag_ids">
              <SelectInput optionText="name" variant="standard" size="medium" />
            </ReferenceInput>
            <TextInput source="foo" variant="standard" size="medium" />
          </Stack>
          <Stack sx={{ width: 200 }}>
            <ReferenceInput reference="tags" resource="posts" source="tag_ids">
              <SelectInput optionText="name" variant="outlined" size="medium" />
            </ReferenceInput>
        ...
        <Stack direction="row" spacing={2}>
          ...
          <Stack sx={{ width: 200 }}>
            ...
            <TextInput source="foo" variant="standard" margin="normal" />
          </Stack>
          <Stack sx={{ width: 200 }}>
            <ReferenceInput reference="tags" resource="posts" source="tag_ids">
              <SelectInput
            ...
            <TextInput source="foo" variant="outlined" margin="normal" />
          </Stack>
        </Stack>
      </Form>
    </Paper>
  ...
  <Edit>
    <SimpleForm>
      ...
      <ArrayInput source="books">
        <SimpleFormIterator>
          <TextInput source="title" />
          <ReferenceInput reference="authors" source="author_id" perPage={1} />
        </SimpleFormIterator>
      </ArrayInput>
    </SimpleForm>
  </Edit>
          ...
          collections: [
            {
              ...
              books: [
                ...
                },
                {
                  ...
                  author_id: 2,
                  summary:
                    'Les Misérables is a English historical novel by Victor Hugo, first published in 1862, that is considered one of the greatest novels of the 19th century.',
                  year: 1862,
                },
              ],
            },
